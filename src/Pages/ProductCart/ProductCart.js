            ...
            <div className="rounded-lg shadow-lg bg-white max-w-sm overflow-hidden relative">
                ...
                <div className="p-3 ">
                    ...
                    <div className='mb-10 
                                    ...
                                    justify-between
                                    '>
                    <p className="text-xl tracking-tight text-gray-900 flex items-center"><span className='text-sm mr-1'>Supplier: </span>{supplier}</p>
                    ...
                    <div className='absolute bottom-0 w-full left-0 text-center'>
                        <div className='text-center '>
                            <Link to={`/inventory/${_id}`} className="inline-flex text-decoration-none  items-center justify-center w-full  py-2.5 mt-2  px-3 text-1xl  font-medium text-center text-white bg-blue-700 rounded-b-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Manage Stock
